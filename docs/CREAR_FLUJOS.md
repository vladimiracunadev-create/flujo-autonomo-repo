...
Un flow es un proceso ejecutable dentro de `flows/<nombre>/`. Debe ser comprensible para una persona y válido para el motor.
...
| Campo | Nivel | Uso |
| --- | --- | --- |
| `id` | manifest/step | identificador estable |
